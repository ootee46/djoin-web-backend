...
@Component({
    selector: 'dashboard-minute-approve',
    templateUrl: './minute-approve.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class DashboardMinuteApproveComponent
    implements OnInit, OnDestroy, AfterViewInit
{
    ...
    ngOnInit(): void {
        this.listData$ = this._service.minuteApproves$;
    }
    ...
    loadData(): void {
        ...
        this._service
            .getMinuteApproves(this.searchQuery)
            .pipe(take(1))
            .subscribe(() => {
                if (this.paginator) {
                    if (!this._isPageLoad) {
    ...
    viewDetal(item: MinuteRequestListModel): void {
        this._router.navigate(['/approver/minute-approve/detail', item.id], {
