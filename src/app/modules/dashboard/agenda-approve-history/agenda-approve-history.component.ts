...
@Component({
    selector: 'dashboard-agenda-approve-history',
    templateUrl: './agenda-approve-history.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class DashboardAgendaApproveHistoryComponent
    ...
    detail$: Observable<AgendaRequestItemModel>;
    ...
    ngOnInit(): void {
        this.listData$ = this._service.agendaApproveHistories$;
        this.detail$ = this._service.agendaApproverDetail$;
    ...
    loadData(): void {
        ...
        this._service
            .getAgendaApproveHistories(this.searchQuery)
            .pipe(take(1))
            .subscribe(() => {
                if (this.paginator) {
                    if (!this._isPageLoad) {
    ...
    viewDetal(item: AgendaRequestItemListModel): void {
        ...
        this._splash.show();
        this._service.getAgendaApproveDetail(item.id).pipe(take(1)).subscribe(() => {
            this._splash.hide();
            setTimeout(() => {
