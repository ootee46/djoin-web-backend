...
@Component({
    selector: 'dashboard-agenda-attachment-permission',
    templateUrl: './view-permission.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class DashboardAgendaApprovePermissionComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    constructor(
        private _matDialogRef: MatDialogRef<DashboardAgendaApprovePermissionComponent>,
