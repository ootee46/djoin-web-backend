...
@Component({
    selector: 'meeting-agenda-view-attachment-permission',
    templateUrl: './view-permission.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class AgendaViewPermissionComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    constructor(
        private _matDialogRef: MatDialogRef<AgendaViewPermissionComponent>,
