...
@Component({
    selector: 'agenda-reservation-attachment-permission',
    templateUrl: './view-permission.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class AgendaReservationPermissionComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    constructor(
        private _matDialogRef: MatDialogRef<AgendaReservationPermissionComponent>,
