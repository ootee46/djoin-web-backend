...
export class RequestInfoComponent implements OnInit, OnDestroy {
    ...
    createDataForm(): UntypedFormGroup {
        return this._formBuilder.group({
            ...
            'isVote': [this.data.isVote || false],
            'isVoteOpen': [this.data.isVoteOpen || false],
            'isConfirm': [this.data.isConfirm || false],
            'title': [this.data.title, [Validators.required, Validators.maxLength(900), CustomValidator.whiteSpace]],
            'description': [this.data.description, [ Validators.maxLength(2000), CustomValidator.whiteSpace]],
