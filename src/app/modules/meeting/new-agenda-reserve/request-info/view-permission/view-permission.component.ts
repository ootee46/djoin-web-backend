...
@Component({
    selector: 'request-info-permission',
    templateUrl: './view-permission.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class RequestInfoPermissionComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    constructor(
        private _matDialogRef: MatDialogRef<RequestInfoPermissionComponent>,
