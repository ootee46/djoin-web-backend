...
@Component({
    selector: 'meeting-approve-attachment-permission',
    templateUrl: './view-permission.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class MinuteApprovePermissionComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    constructor(
        private _matDialogRef: MatDialogRef<MinuteApprovePermissionComponent>,
